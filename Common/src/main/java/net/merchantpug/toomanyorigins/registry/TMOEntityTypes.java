...
public class TMOEntityTypes {
    private static final RegistrationProvider<EntityType<?>> ENTITY_TYPES = RegistrationProvider.get(Registries.ENTITY_TYPE, TooManyOrigins.MOD_ID);

    public static final RegistryObject<EntityType<SmallDragonFireballEntity>> SMALL_DRAGON_FIREBALL = register("small_dragon_fireball", () -> EntityType.Builder.<SmallDragonFireballEntity>of(SmallDragonFireballEntity::new, MobCategory.MISC).sized(0.25f, 0.25f).clientTrackingRange(64).updateInterval(10).build("toomanyorigins:small_dragon_fireball"));
    public static final RegistryObject<EntityType<FireballAreaEffectCloudEntity>> FIREBALL_AREA_EFFECT_CLOUD = register("fireball_area_effect_cloud", () -> EntityType.Builder.<FireballAreaEffectCloudEntity>of(FireballAreaEffectCloudEntity::new, MobCategory.MISC).fireImmune().sized(6.0F, 0.5F).clientTrackingRange(10).updateInterval(2147483647).build("toomanyorigins:fireball_area_effect_cloud"));
