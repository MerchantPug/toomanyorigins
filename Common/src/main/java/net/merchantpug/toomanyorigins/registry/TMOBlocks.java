...
public class TMOBlocks {
    ...
    public static final RegistryObject<Block> WITHERED_CROP = register("withered_crop", () -> new WitheredCropBlock(() -> TMOItems.WITHERED_CROP_SEEDS.get(), BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.CROP)));
    public static final RegistryObject<Block> WITHERED_STEM = register("withered_stem", () -> new WitheredStemBlock(() -> TMOItems.WITHERED_STEM_SEEDS.get(), BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).noCollission().randomTicks().instabreak().sound(SoundType.STEM)));
